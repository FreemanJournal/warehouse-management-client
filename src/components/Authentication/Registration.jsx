        ...
        <div className="px-6 py-8 pt-24">
          <div className="w-full sm:w-6/12 mx-auto  rounded-sm shadow-lg  bg-white ">
            ...
            <div className=" w-full flex-wrap flex flex-col sm:flex-row justify-center items-center gap-5  space-y-2 p-4 mt-3 text-[15.5px] leading-relaxed text-gray-500">
              ...
              <div className="flex relative  justify-center items-center pb-10 sm:pb-0">
                <button onClick={googleSignInHandler}
                  className="mx-auto flex gap-1 justify-center font-semibold duration-300  py-2 px-10 shadow-sm rounded-sm  text-slate-600 hover:text-pink-600 border hover:border-pink-500" >
                  <FcGoogle className='font-bold text-2xl' /><span>Continue with google</span>
                </button>
                <p className='absolute -bottom-1 sm:-bottom-28  cursor-pointer duration-300 hover:underline hover:text-pink-500' onClick={() => navigate("/login")}>Already have an account ?</p>
